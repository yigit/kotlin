...
class JvmIdeServicesTest : TestCase() {
    ...
    companion object {
        ...
        private val outputJarDir = Files.createTempDirectory("temp-ide-services")
        ...
        private fun compileFile(inputKtFileName: String, outputJarName: String): CliCompilationResult {
            val jarPath = outputJarDir.resolve(outputJarName).toAbsolutePath().toString().let {
                if (File.pathSeparator  != "/") it.replace(File.pathSeparator, "/") else it
            }
