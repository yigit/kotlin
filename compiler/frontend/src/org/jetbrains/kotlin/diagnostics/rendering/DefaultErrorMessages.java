...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(DEPRECATED_SYNTAX_WITH_DEFINITELY_NOT_NULL, "This kind of syntax is deprecated. Since 1.6, ''!!'' to the type from the right operand (currently it's being applied to the whole expression)");
